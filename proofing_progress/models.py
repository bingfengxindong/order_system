...
class ProofingProgress(models.Model):
    ...
    pp_Modify_sample_order_date = models.DateField(blank=True,null=True,verbose_name="下单时间（修改）")
    pp_Modify_sample_arrival_date = models.DateField(blank=True,null=True,verbose_name="到料时间（修改）")
    pp_Modify_sample_express_date = models.DateField(blank=True,null=True,verbose_name="快递时间（修改）")
