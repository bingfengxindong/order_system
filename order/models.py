...
class Order(models.Model):
    ...
    o_customer = models.OneToOneField("Customer", blank=True, null=True, on_delete=models.CASCADE, verbose_name="客户")
    o_capcolor = models.ManyToManyField("CapColor", blank=True, verbose_name="颜色")
    o_captype = models.OneToOneField("CapType", blank=True, null=True, on_delete=models.CASCADE, verbose_name="帽型")
    o_embroiderorprint = models.OneToOneField("EmbroiderOrPrint", blank=True, null=True, on_delete=models.CASCADE, verbose_name="绣印花")
    o_capeyebrow = models.OneToOneField("CapEyebrow", blank=True, null=True, on_delete=models.CASCADE, verbose_name="帽眉")
    o_versionnumber = models.OneToOneField("VersionNumber", blank=True, null=True, on_delete=models.CASCADE,verbose_name="版号")
    o_afterdeduction = models.OneToOneField("AfterDeduction", blank=True, null=True, on_delete=models.CASCADE,verbose_name="后扣")
    o_user = models.OneToOneField(User, blank=True, null=True, on_delete=models.CASCADE, verbose_name="业务员")
